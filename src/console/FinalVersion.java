...
public class FinalVersion {
    static final int MAX_INNINGS = 3;
    static String name[] = { // Players Involved
    ...
    static String outcomes[] = {        // BaseBall outcomes & probability
            "Homerun", "Single", "Single", "Single", "Single", "Double", "Double", "Triple",
    ...
    public static void main(String args[]) throws InterruptedException {
        ...
        // Bases
        String baseOne = null; // 1st Base
        String baseTwo = null; // 2nd Base
        String baseThree = null; // 3rd Base
        String home = null; // Home plate ?
        ...
        GAME:
        while (gameOn) {
            for (int inn = 1; inn <= MAX_INNINGS; inn++) {
        ...
        String winner = teamScore1 > teamScore2 ? teamName1 : teamName2;
